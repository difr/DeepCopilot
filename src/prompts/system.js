...
function buildSystemPrompt(opts = {}) {
    ...
    if (opts.mode === 'plan') {
        dynamicParts.push(
            ...
            'You are in Plan mode. You MAY use read-only tools (read_file, grep_search, list_dir, find_files, diff_files, web_search, web_fetch, fetch_top) to investigate the task. ' +
